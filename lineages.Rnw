...
<<echo=FALSE, plot_unfilter, comment='', fig.lp="fig:", fig.cap = "Quality results for the mtDNA SNP calls before filtering.", fig.pos='h!'>>=
plot(pinf_mt)
@
...
<<echo=FALSE, comment='', chromogc, fig.lp="fig:", fig.cap = "Whole mtDNA genome scan for the P. infestans samples.",  fig.pos='h!', results='hide'>>=
chromoqc(pinf_mt)
@
