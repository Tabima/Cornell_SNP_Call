...
#
library(xtable)
ptab <- xtable(cbind(pinf_mt@vcf.fix[pinf_mt@var.info$mask,c(1,2,4,5)],1:sum(pinf_mt@var.info$mask)))
...
\includepdf[pages={-}, nup=2x2]{All_traces_2.pdf}
