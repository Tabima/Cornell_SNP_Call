...
<<echo=FALSE, plot_unfilter, comment='', fig.lp="fig:", fig.cap = "Quality results for the mtDNA SNP calls before filtering.", fig.pos='p'>>=
plot(pinf_mt)
@
...
<<echo=FALSE, plot_filter, comment='', fig.lp="fig:", fig.cap = "Quality results for the mtDNA SNP calls after filtering and windowizing variants.", fig.pos='p'>>=
plot(pinf_mt)
@
